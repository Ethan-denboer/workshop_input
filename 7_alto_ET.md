...
tree = ET.parse('xml-workshop/data/alto_id1.xml')
...
```{code-cell}
:tags: [remove-input, hide-output]
tree = ET.parse('xml-workshop/data/didl_id1.xml')
root_didl = tree.getroot()
ns_didl = {'dc': 'http://purl.org/dc/elements/1.1/',
          'ns2': 'urn:mpeg:mpeg21:2002:02-DIDL-NS', 
          'ns4' : 'info:srw/schema/1/dc-v1.1' }
...
print("The contents of the title variable should look like this:")
print(title)
```

```{code-cell}
:tags: [remove-input, hide-output]
print("The contents of the date variable should look like this:")
print(date)
```
...
Collecting all articles from all newspapers may not be specific enough, and may also extract a lot of unwanted data.
It is possible to selectively extract information from a specific newspaper, leading to a more dedicated dataset.
